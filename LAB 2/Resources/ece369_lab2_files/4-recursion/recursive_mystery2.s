...
#		It sums the first $a0 indexes thar are greater than or equal to 5
#		If the number of indexes given by $a0 is greater than that in list,
#			values in the next list are accessed and summed accoring to
#			the above rule until number of indexes compared are eqaul to $a0
