...
#       1001004 is the address of the first element of array X
#
# 1(b) What is the address location of the last element (element 7) of the array, X.
#       1001000C is the address of the last element of array X
#
# 2.   What are the values at location 'SUM' as the program executes?
#       (0,1) - 0 at program initilization and 1 at the store word operation
#
...
#       Register $t0 holds the address of array X, and is used to icrement across the array
#
#
